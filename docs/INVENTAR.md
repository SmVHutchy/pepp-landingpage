...
| `/impressum`        | `src/pages/impressum.astro` (13 Z.)        | Impressum · Pepp                                      | fertig         | Lädt `src/content/legal/impressum.html?raw` (93 Z.) über `Legal.astro`.                                                                                                                                                                                                                                                                                                                                                                        |
| `/datenschutz`      | `src/pages/datenschutz.astro` (11 Z.)      | Datenschutzerklärung · Pepp                           | fertig         | Lädt `src/content/legal/datenschutz.html?raw` (192 Z.).                                                                                                                                                                                                                                                                                                                                                                                        |
| `/agb`              | `src/pages/agb.astro` (11 Z.)              | AGB · Pepp                                            | fertig         | Lädt `src/content/legal/agb.html?raw` (240 Z.).                                                                                                                                                                                                                                                                                                                                                                                                |
