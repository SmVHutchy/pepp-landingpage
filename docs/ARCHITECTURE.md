...
| `src/legal/`                       | Drei rohe HTML-Fragmente (Impressum, Datenschutz, AGB). Fremdtext, wortgleich übernommen, wird per `?raw` zur Buildzeit eingelesen (`impressum.astro:6`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
`src/legal/agb.html` nennt eigene Beträge als Fremdtext (die AUDIT-Datei führt
...
(`src/legal/impressum.html:6-30`, `agb.html:11-16`, `datenschutz.html:7-12`) und
