...
| `curl localhost:4321` liefert nichts, Browser aber schon        | Server lauscht auf dem anderen IP-Stack (hier zuletzt IPv4)              | `curl http://[::1]:4321/` bzw. `curl http://127.0.0.1:4321/`                                                  |
