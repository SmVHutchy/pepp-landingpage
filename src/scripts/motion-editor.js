...
const FIELDS = [
  { group: 'text', label: 'Text · Weg', key: 'y', min: 0, max: 64, step: 1, unit: 'px' },
  { group: 'text', label: 'Text · Dauer', key: 'duration', min: 0.1, max: 1.6, step: 0.05, unit: 's' },
  { group: 'text', label: 'Text · Stagger', key: 'stagger', min: 0, max: 0.3, step: 0.01, unit: 's' },
  { group: 'text', label: 'Text · Ease', key: 'ease', options: EASES },
  { group: 'text', label: 'Text · Trigger', key: 'start', options: ['top 90%', 'top 85%', 'top 78%', 'top 70%', 'top 60%'] },

  { group: 'card', label: 'Karten · Weg', key: 'y', min: 0, max: 64, step: 1, unit: 'px' },
  { group: 'card', label: 'Karten · Dauer', key: 'duration', min: 0.1, max: 1.6, step: 0.05, unit: 's' },
  { group: 'card', label: 'Karten · Stagger', key: 'stagger', min: 0, max: 0.3, step: 0.01, unit: 's' },
  { group: 'card', label: 'Karten · Ease', key: 'ease', options: EASES },

  { group: 'headline', label: 'Headline · Modus', key: 'mode', options: ['lines', 'block'] },
  { group: 'headline', label: 'Headline · Weg', key: 'y', min: 0, max: 64, step: 1, unit: 'px' },
  { group: 'headline', label: 'Headline · Dauer', key: 'duration', min: 0.1, max: 1.6, step: 0.05, unit: 's' },
  { group: 'headline', label: 'Headline · Stagger', key: 'stagger', min: 0, max: 0.3, step: 0.01, unit: 's' },
  { group: 'headline', label: 'Headline · Ease', key: 'ease', options: EASES },

  { group: 'heroParallax', label: 'Parallax · Pepp', key: 'figure', min: -80, max: 80, step: 2, unit: 'px' },
  { group: 'heroParallax', label: 'Parallax · Scrub', key: 'scrub', min: 0, max: 2, step: 0.1, unit: 's' },

  { group: 'mechanic', label: 'Mechanik · Pin ab', key: 'pinFrom', min: 320, max: 1440, step: 1, unit: 'px' },
  { group: 'mechanic', label: 'Mechanik · Fade aus', key: 'fadeOut', min: 0, max: 0.6, step: 0.02, unit: 's' },
  { group: 'mechanic', label: 'Mechanik · Fade ein', key: 'fadeIn', min: 0, max: 0.6, step: 0.02, unit: 's' },
];
